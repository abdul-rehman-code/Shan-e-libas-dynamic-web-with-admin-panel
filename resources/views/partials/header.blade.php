...
<!-- Main Navigation Bar (Glassmorphism Glass Effect) -->
<nav class="bg-white/75 backdrop-blur-md sticky top-0 z-50 border-b border-gray-200/50 shadow-xs">
...
<div class="flex-shrink-0 flex items-center">
    <a href="/" class="block group">
        <!-- Logo Image (Height barha di hai) -->
        <img src="{{ asset('assets/logo/logo.png') }}"
             alt="Shan-E-Libas Logo"
             class="h-20 sm:h-24 w-auto object-contain transition-transform duration-300 group-hover:scale-105">
    </a>
</div>
            ...
            <div class="hidden md:flex space-x-7 font-bold text-xs tracking-widest uppercase">
                ...
                <a href="/products" class="text-gray-600 hover:text-[#8A151B] transition pb-1">All Products</a>
