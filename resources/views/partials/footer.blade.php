...
<!-- Email Link -->
<li class="flex items-start text-sm text-gray-500">
    <a href="mailto:info@shanelibas.store" class="flex items-center space-x-2 hover:text-[#6E472D] transition duration-200">
        <svg class="w-4 h-4 text-[#6E472D] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
        </svg>
        <span class="break-all text-xs sm:text-sm">info@shanelibas.store</span>
    </a>
</li>
            ...
            <div class="col-span-2 md:col-span-1 flex flex-col space-y-4">
                ...
                <form class="flex flex-col space-y-2.5">
                    <input type="email" placeholder="Enter your email" required
                           class="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-sm focus:outline-hidden focus:ring-1 focus:ring-[#6E472D] focus:bg-white transition duration-200">
                    <button type="submit"
                            class="w-full bg-[#6E472D] hover:bg-[#533521] text-white text-xs font-bold uppercase tracking-widest py-3 px-4 rounded-xl transition duration-300 active:scale-98 shadow-xs cursor-pointer">
                        Subscribe
                    </button>
                </form>
            </div>
