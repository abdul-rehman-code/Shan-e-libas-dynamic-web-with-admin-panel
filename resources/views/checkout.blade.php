                ...
                <div class="lg:col-span-5">
                    <div class="bg-white p-6 sm:p-8 rounded-3xl shadow-sm border border-gray-100 sticky top-6">
                        ...
                        <button type="submit" :disabled="loading"
                            class="w-full mt-6 bg-[#4A3222] hover:bg-[#362418] disabled:bg-gray-400 text-white text-sm font-bold py-4 px-4 rounded-2xl uppercase tracking-wider transition shadow-sm flex items-center justify-center space-x-2">
